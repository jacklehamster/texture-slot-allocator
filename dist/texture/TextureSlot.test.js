...
describe('TextureSlot', () => {
    ...
    it('should correctly convert a position to a texture slot', () => {
        ...
        const position = { x: MIN_TEXTURE_SIZE, y: 2 * MIN_TEXTURE_SIZE, size: [2 * MIN_TEXTURE_SIZE, 2 * MIN_TEXTURE_SIZE], textureIndex: 1 };
...
//# sourceMappingURL=TextureSlot.test.js.map